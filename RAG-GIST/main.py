...
prompt_template = ChatPromptTemplate.from_template(
    """"
    Answer the questions based only on following context:
    {context}
    Question: {question}
...
if __name__ == "__main__":
    ...
    # Query
    query = "What is Pinecoe in Machine Learning?"
    ...
    # ========================================================================
    # Option 2: Use implementation WITH LCEL (Langchain Expression Language) (Better Approach)
    # ========================================================================
    print("\n" + "=" * 70)
